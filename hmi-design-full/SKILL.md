---
name: hmi-design-full
description: Comprehensive ISA-101 design rules for Human Machine Interfaces in process automation, with detailed reference files covering color design, display hierarchy, navigation, alarms, human factors, performance, and lifecycle management. Use when designing, building, reviewing, or generating code for HMIs, control system displays, SCADA screens, or industrial control panels and comprehensive ISA-101 coverage is needed. Use when deep-diving into alarm design, color standards, navigation patterns, human factors, performance requirements, or HMI lifecycle management. Not for general web dashboards, business analytics, or consumer UIs.
---
...
For comprehensive guidance on specific topics, load the relevant file:

| File | Topic |
|------|-------|
| `references/color-and-visual-design.md` | Color hierarchy, color-blindness tables, ambient lighting, density by level, typography details |
| `references/display-hierarchy-and-styles.md` | ASCII layout patterns per level, all display style details, navigation between levels |
| `references/navigation-and-interaction.md` | Navigation method types, yoking, data entry conventions, decimal formatting tables, role-based security |
| `references/alarm-design.md` | Alarm banner patterns, alarm-driven navigation, auditory design, shelved/suppressed alarm lists |
| `references/situation-awareness-and-human-factors.md` | Progressive alerting, cognitive load management, sensory design limits, abnormal situation design |
| `references/performance-requirements.md` | System categories (SCADA, high-speed, RTU), stress testing, call-up strategies |
| `references/lifecycle-and-management.md` | HMI philosophy/style guide/toolkit, lifecycle stages, MOC, user types, scripting rules |
